    ...
    <div style={containerStyle}>
      ...
      <p>
        ...
        <span style={{ color: "#064e3b" }}>:tunaweza kuchengesha maana kamili kwa maneno ya Kiswahili (changamoto ya misamiati au tafsiri) lakini maneno yafuatayo yanatafsiri kwa kupunguza
          ...
          vinazaa <span style={{fontWeight: "bold"}}>Art(Sanaa),Creativity(Ubunifu),
          Wisdom(Hekima),and Meaning(na Maana)</span> na wajukuu wake ni <span style={{fontWeight: "bold"}}>Philosophy(Falsafa),
            Mathematics(Hisabati) and Science(na Sayansi)</span>.
        </span>
        {ending}
      </p>
      <p>
